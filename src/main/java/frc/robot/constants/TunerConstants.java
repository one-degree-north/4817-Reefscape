...
public class TunerConstants {
    public static final double trackWidth = Inches.convertFrom(22.75, Meters);
    public static final double wheelBase = Inches.convertFrom(22.75, Meters);
    ...
    private static final double kCoupleRatio = 50/16;
